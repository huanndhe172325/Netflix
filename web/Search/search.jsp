<%-- 
    Document   : search
    Created on : Mar 14, 2024, 8:43:35 PM
    Author     : FPT
--%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${empty listFilmFind}">
            <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
                <div>
                    <p>Your search for "${input}" did not have any matches.</p>
                    <p>Suggestions:</p>
                    <ul>
        ...
        <c:if test="${not empty listFilmFind}">
                        ...
                        <div class="col-sm-12 overflow-hidden">
                            <div class="favorite-contens">
                                <ul class="favorites-slider list-inline row p-0 mb-0">
                                    <!-- slide item 1 -->
                                    <c:forEach var="film" items="${listFilmFind}" varStatus="loop">    
