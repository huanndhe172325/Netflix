...
<html>
    ...
    <body>
        <h2 style="text-align: center;">Update film ${idFilm} <button onclick="location.href = 'manageMovies'">Back</button></h2>
        <h2 style="text-align: center;">${success} xxxxxxxxxx</h2>

        <form action="updateMovies" method="post" enctype="multipart/form-data">
            <input style="display: none;" name="idFilm" value="${film.IDFilm}" required>
            ...
            <textarea id="Detail" name="Detail" required>${film.detail}</textarea>
