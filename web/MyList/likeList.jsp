...
<html>
    ...
    <body>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <div class="menu-main-menu-container">
                                        <ul id="top-menu" class="navbar-nav ml-auto">
                                            ...
                                            <li class="menu-item"><a href="#">Liked</a></li>
                                            <li class="menu-item">
                                                <a href="#">Contact Us</a>
                                                <ul class="sub-menu">
        ...
        <c:if test="${empty listFilmLiked}">
            <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
                <div>
                    <p>Your liked list is currently empty.</p>
                    <p> <a href="browse" style="text-decoration: underline;">Start add</a>  movies to the list!</p>
                </div>
            </div>
        </c:if>
        <c:if test="${not empty listFilmLiked}">
                        ...
                        <div class="col-sm-12 overflow-hidden">
                            <div class="favorite-contens">
                                <ul class="favorites-slider list-inline row p-0 mb-0">
                                    <!-- slide item 1 -->
                                    <c:forEach var="film" items="${listFilmLiked}" varStatus="loop">    
