<%-- 
    Document   : myList
    Created on : Mar 15, 2024, 2:50:26 PM
    Author     : FPT
--%>
...
<html>
    ...
    <body>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <div class="menu-main-menu-container">
                                        <ul id="top-menu" class="navbar-nav ml-auto">
                                            ...
                                            <li class="menu-item"><a href="movies">Movies</a></li>
        ...
        <c:if test="${empty listFilmFavourite}">
            <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
                <div>
                    <p>Your favorites list is currently empty.</p>
                    <p> <a href="browse" style="text-decoration: underline;">Start add</a>  your favorite items to the list!</p>
                </div>
            </div>
        </c:if>
        <c:if test="${not empty listFilmFavourite}">
            <section id="iq-favorites" style="padding-top: 120px">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="favorite-contens">
                                <ul class="favorites-slider list-inline row p-0 mb-0">
                                    <!-- slide item 1 -->
                                    <c:forEach var="film" items="${listFilmFavourite}" varStatus="loop">    
                                                ...
                                                <div class="block-social-info">
                                                    <ul class="list-inline p-0 m-0 music-play-lists">
                                                        <c:if test="${film.status}">
                                                            ...
                                                            <li>
                                                                <span onclick="confirmSubmitMyListForm('${film.IDFilm}')"><i class="fa fa-minus"></i></span>
                                                            </li>
                                                        </c:if>
                                                    </ul>
                                                </div>
        ...
        <form id="myListForm" action="myList" method="post" style="display: none;">
            <input type="hidden" id="filmIdInput" name="filmId">
        </form>
        <!-- js files  -->
        ...
        <script>
                                                                function confirmSubmitMyListForm(filmId) {
                                                                    var confirmation = confirm("Do you want to remove this movie from your favorites?");
                                                                    if (confirmation) {
                                                                        submitMyListForm(filmId);
                                                                    }
                                                                }

                                                                function submitMyListForm(filmId) {
                                                                    document.getElementById('filmIdInput').value = filmId;
