...
public class Movies extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cName == null || cName.equals("All")) {
            allFilm = dao.getFilmByName("30", "");
            data.removeDuplicates(allFilm);
        } else {
            allFilm = dao.getFilmByCategory("30", cName);
        }
        ...
        request.getRequestDispatcher("Movies/Movie.jsp").forward(request, response);
    }
